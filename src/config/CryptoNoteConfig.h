...
// Copyright (c) 2019, The Sastoramro Developers
// 
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 338821; // PPRC
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(1000000000); // 10 million
...
const char     CRYPTONOTE_NAME[]                             = "PiperChain";
...
const int      P2P_DEFAULT_PORT                              =  12702;
const int      RPC_DEFAULT_PORT                              =  12079;
...
{
    {  0x28, 0x03, 0x86, 0x14, 0xea, 0x94, 0xe0, 0xf2, 0x0a, 0x86, 0x84, 0xfd, 0x4f, 0x9b, 0xfe, 0x6b  }
};
